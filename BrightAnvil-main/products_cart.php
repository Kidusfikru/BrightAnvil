        ...
        <div class="row px-5">
                  ...
                  if($count>0)
                  {
                    ...
                    $cart = json_decode($cart);
                       ...
                       while($row = mysqli_fetch_assoc($res4))
                       {
                           ...
                           if($flag==true)
                           {
                            cartElement($row['image_name'], $row['title'],$row['price'],$row['id'],$row['description']);
                  ...
                  <?php if(isset($_COOKIE['cart']))
          {
            ...
            echo "<h6>Price (0 items)</h6>";
                  ...
                  <hr>
                  <button style = "width:150px;"name ="continue" type ="submit" class="btn btn-success mx-2 my-2" >continue shopping</button>
                  
                  <button style = "width:150px;" name ="update" type ="submit" class="btn btn-warning mx-2 my-2">update cart</button>
                  
                  <button style = "width:150px;" name ="checkout" type ="submit" class="btn btn-danger mx-2 my-2" >check outer</button>
                <br>  
                </form>
                </div>
